...
<div class="container">
    <form class="form-horizontal" role="form" enctype="multipart/form-data" method="POST" action="registration_process.php">
        <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-6">
                <h2 class="mt-3 text-center">STUDENT REGISTRATION</h2>
                <hr>
            </div>
        </div>
        <div class="row mt-4">
